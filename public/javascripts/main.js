...
$(document).ready(function () {
        ...
        $('#scoreList table tbody').on('click', 'td a.linkshowscore', showUserInfo);
        // Delete User link click
        $('#scoreList table tbody').on('click', 'td a.linkdeletescore', deleteUser);
...
function populateTable() {
    ...
    $.getJSON('/users/highscore', function (data) {
        ...
        $.each(data, function () {
            tableContent += '<tr>';
            tableContent += '<td><a href="#" class="linkshowname" rel="' + this.name + '">'
                + this.name + '</a></td>';
            tableContent += '<td><a href="#" class="linkshowscore" rel="' + this.score + '">'
                + this.score + '</a></td>';
...
function showUserInfo(event) {
    ...
    //Populate Info Box
    $('#userInfoName').text(thisScoreObject.name);
};
...
function deleteUser(event) {
    ...
    if (confirmation === true) {
        ...
        $.ajax({
            type: 'DELETE', url: '/users/deleteuser/' + $(this).attr('rel')
